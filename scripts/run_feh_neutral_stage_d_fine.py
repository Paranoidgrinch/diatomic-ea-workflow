...
print("=" * 132)
print("FeH NEUTRAL — STAGE D: FINE PEC + POINTWISE QC")
print("=" * 132)
print(flush=True)
...
# =====================================================================
# Final two-candidate resolution
# =====================================================================
...
print(
    "Expected primary: SEED_BRANCH_016"
)

print(
    "Expected Re ~= 1.56741 A"
)

print(
    "Expected alternative gap ~= +0.73 meV"
)

print(
    "Expected electronic relation: AMBIGUOUS"
)

print(
    "Expected energetic ordering: primary lower at every common Fine point"
)

print()
print("=" * 132)
print("FeH NEUTRAL STAGE D COMPLETE")
print("=" * 132)
